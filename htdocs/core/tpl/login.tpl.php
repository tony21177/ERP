...
<input type="text" id="comp" maxlength="255" placeholder="comp" name="comp" class="flat input-icon-user minwidth150" value="<?php echo dol_escape_htmltag($login); ?>" tabindex="1" autofocus="autofocus" />
</div>
</div>
